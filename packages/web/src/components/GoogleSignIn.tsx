...
export function GoogleSignIn({ onLogin }: Props) {
  return (
    <button type="button" className="cta-google" onClick={onLogin}>
      <svg width="18" height="18" viewBox="0 0 18 18" fill="none">
        ...
        <path d="M9 18c2.43 0 4.467-.806 5.956-2.18l-2.908-2.26c-.806.54-1.837.86-3.048.86-2.344 0-4.328-1.584-5.036-3.711H.957v2.332A8.997 8.997 0 0 0 9 18z" fill="#fff" />
      ...
      <span className="cta-arrow">&rsaquo;</span>
    </button>
  );
}
